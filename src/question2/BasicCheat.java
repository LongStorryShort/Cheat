...
public class BasicCheat implements CardGame{
    ...
    private question1.Hand discards;
    ...
    public BasicCheat(int n){
        ...
        currentBid=new Bid();
        currentBid.setRank(question1.Card.Rank.TWO);
        currentPlayer=0;
    }
    ...
    public boolean playTurn(){
        ...
        System.out.println(currentBid.getHand());
...
//Go to the next player       
    ...
    public void initialise(){
            ...
            question1.Deck d=new question1.Deck();
            d.shuffle();
            //Deal cards to players
            Iterator<question1.Card> it= d.iterator();
            int count=0;
            while(it.hasNext()){
    ...
    public static boolean isCheat(Bid b){
            for(question1.Card c:b.getHand()){
                    if(c.rank.getRank()!=b.r.getRank())
                            return true;
            }
            return false;
    }
